...
public class PrevisioneAPI{
    ...
    public static void StampaPrevisioniGiornaliere(String nomeLocalita) throws UnirestException, ApiKeyException, InterruptedException {
        ...
        for(int i=0; i<24; i++){
            ...
            System.out.println(ColorText.PURPLE + "Ore " + oraPrevisioneString + " | " + ColorText.YELLOW + "Temperatura attuale: " + previsioni.get("hourly").getAsJsonArray().get(i).getAsJsonObject().get("temp").toString() + "°");
            ...
            System.out.println("Stato meteo - " + previsioni.get("hourly").getAsJsonArray().get(i).getAsJsonObject().get("weather").getAsJsonArray().get(0).getAsJsonObject().get("description").toString());
            System.out.println("---------------------------------------------");
    ...
    public static void StampaPrevisioniSettimanali(String nomeLocalita) throws ApiKeyException, UnirestException, InterruptedException {
        ...
        for(int i=0; i<7; i++){
            ...
            System.out.println("Stato generale: " + previsioni.get("daily").getAsJsonArray().get(i).getAsJsonObject().get("weather").getAsJsonArray().get(0).getAsJsonObject().get("description").toString() + " | Umidita': " + previsioni.get("daily").getAsJsonArray().get(i).getAsJsonObject().get("humidity").toString() + "%");
            System.out.println("---------------------------------------------");
