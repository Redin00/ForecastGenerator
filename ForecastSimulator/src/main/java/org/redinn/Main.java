    ...
    public static void main(String[] args) throws Exception {
        ...
        // Se abbiamo scelto le previsioni reali con uso di API
            ...
            while(inputLoop) {
                ...
                nomeLocalita = nomeLocalita.replace(" ", "%20");2b 

                if(nomeLocalita.length() < 3){
                    System.out.println(ColorText.RED + "Errore! Inserisci almeno 3 caratteri per trovare una citta' valida!");
                }
                else if(!PrevisioneAPI.localitaEsistente(nomeLocalita)){
                    System.out.println(ColorText.RED + "Errore! Localita' inserita non esistente! Inserirne una nuova!");
                }
                else{
                    inputLoop = false;
                }
